    ...
    <section class="hero-section container mb-200">
        ...
        <div class="hero-section-content">
            ...
            <h1 class="hero-section-title mb-24">Potenciá tus habilidades digitales con <span
                    class="primary-color-text">contenido especializados</span></h1>

            <p class="paragraph hero-section-description mb-32">Avanzá en tu camino IT con el catálogo más completo de
                cursos cortos, hecho especialmente para que puedas profundizar tus conocimientos y destacar en el mercado
                laboral actual.</p>
