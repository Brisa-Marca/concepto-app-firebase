...
<div class="hero-section-content">
    ...
    <h1 class="hero-section-title mb-24">Potenciá tus habilidades digitales con <span
            class="primary-color-text">tutoriales especializados</span></h1>
    ...
    <a href="html/courses.html" class="main-cta hero-section-cta">
        <p>Explorar cursos</p>
...
<div>
    <img src="assets/png/hero-section.png"
...
<div class="about-concepto-img">
    <img src="assets/png/about-us.png" alt="Notebook con el logo de Concepto">
</div>
...
<p class="subtitle subtitle-center-lines text-center">Categorías populares</p>
<h2 class="h1 h1-bigger text-center mt-8 mb-56">Explorá por rubro</h2>
...
<a href="html/courses.html" class="main-cta m-0-auto">
    <p>Explorar todos</p>
...
<div class="download-img">
    <img src="assets/png/concepto-mobile-app.png" alt="Aplicación mobile de Concepto">
</div>
</section>
</template>